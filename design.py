...
def layouts(sire):
    ...
    sire.tab2_layout.addWidget(sire.mod1_checkbuttons_label)
    ...
    sire.tab2_layout.addWidget(sire.mod2_checkbuttons_label)
    sire.tab2_layout.addWidget(sire.T2_checkbutton)
    sire.tab2_layout.addWidget(sire.B2_checkbutton)
    sire.tab2_layout.addWidget(sire.V2_checkbutton)
    sire.tab2_layout.addWidget(sire.G2_checkbutton)
    sire.tab2_layout.addWidget(sire.A2_checkbutton)
    ...
    sire.tab3_layout.addWidget(sire.reset_wl_range_btn)
    ...
    sire.tab3_layout.addWidget(sire.mA_checkbutton)
    ...
    sire.tab3_layout.addWidget(sire.reset_optical_depth_range_btn)
...
def widgets(sire):
    ...
    sire.mod1_checkbuttons_label = QLabel("Model 1")
    ...
    sire.mod2_checkbuttons_label = QLabel("Model 2")
    sire.T2_checkbutton = QCheckBox("Show temperature", sire)
    sire.T2_checkbutton.setChecked(True)
    sire.T2_checkbutton.setEnabled(False)
    sire.B2_checkbutton = QCheckBox("Show magnetic field strength/flux", sire)
    sire.B2_checkbutton.setChecked(True)
    sire.B2_checkbutton.setEnabled(False)
    sire.V2_checkbutton = QCheckBox("Show velocity", sire)
    sire.V2_checkbutton.setChecked(True)
    sire.V2_checkbutton.setEnabled(False)
    sire.G2_checkbutton = QCheckBox("Show inclination", sire)
    sire.G2_checkbutton.setChecked(True)
    sire.G2_checkbutton.setEnabled(False)
    sire.A2_checkbutton = QCheckBox("Show azimuth", sire)
    sire.A2_checkbutton.setChecked(True)
    ...
    sire.mG_checkbutton = QCheckBox("Show inclination", sire)
    sire.mG_checkbutton.setChecked(True)
    sire.mG_checkbutton.setEnabled(False)
    sire.mA_checkbutton = QCheckBox("Show azimuth", sire)
    sire.mA_checkbutton.setChecked(True)
    sire.mA_checkbutton.setEnabled(False)
    ...
    sire.reset_wl_range_btn = QPushButton("Reset wavelength range")
    sire.reset_wl_range_btn.clicked.connect(lambda: reset_wavelength_range(sire))
    sire.reset_wl_range_btn.setEnabled(False)
    ...
    sire.reset_optical_depth_range_btn = QPushButton("Reset optical depth range")
    sire.reset_optical_depth_range_btn.clicked.connect(lambda: reset_optical_depth_range(sire))
    sire.reset_optical_depth_range_btn.setEnabled(False)
...
def colour_table_widgets(self,sire):
    ...
    self.CT_StkI_autoscaling_checkbutton.setChecked(int(sire.StkI_CT[3]))
    ...
    self.CT_StkQ_autoscaling_checkbutton.setChecked(int(sire.StkQ_CT[3]))
    ...
    self.CT_StkU_autoscaling_checkbutton.setChecked(int(sire.StkU_CT[3]))
    ...
    self.CT_StkV_autoscaling_checkbutton.setChecked(int(sire.StkV_CT[3]))
    ...
    self.CT_T_autoscaling_checkbutton.setChecked(int(sire.T_CT[3]))
    ...
    self.CT_B_autoscaling_checkbutton.setChecked(int(sire.B_CT[3]))
    ...
    self.CT_V_autoscaling_checkbutton.setChecked(int(sire.V_CT[3]))
    ...
    self.CT_G_autoscaling_checkbutton.setChecked(int(sire.G_CT[3]))
    ...
    self.CT_A_autoscaling_checkbutton.setChecked(int(sire.A_CT[3]))
