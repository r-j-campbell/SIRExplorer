...
def layouts(self):
    ...
    self.tab4_grid_layout.addWidget(self.x_spinbox,0,0)
    self.tab4_grid_layout.addWidget(self.y_spinbox,0,1)
    self.tab4_grid_layout.addWidget(self.parameter_label, 1, 0)
    self.tab4_grid_layout.addWidget(self.ff_label, 2, 0)
    self.tab4_grid_layout.addWidget(self.T_label, 3, 0)
    self.tab4_grid_layout.addWidget(self.B_label, 4, 0)
    self.tab4_grid_layout.addWidget(self.V_label, 5, 0)
    self.tab4_grid_layout.addWidget(self.G_label, 6, 0)
    self.tab4_grid_layout.addWidget(self.A_label, 7, 0)
    self.tab4_grid_layout.addWidget(self.mic_label, 8, 0)
    self.tab4_grid_layout.addWidget(self.mac_label, 9, 0)
    self.tab4_grid_layout.addWidget(self.mod1_label, 1, 1)
    self.tab4_grid_layout.addWidget(self.mod1_ff_value, 2, 1)
    self.tab4_grid_layout.addWidget(self.mod1_T_value, 3, 1)
    self.tab4_grid_layout.addWidget(self.mod1_B_value, 4, 1)
    self.tab4_grid_layout.addWidget(self.mod1_V_value, 5, 1)
    self.tab4_grid_layout.addWidget(self.mod1_G_value, 6, 1)
    self.tab4_grid_layout.addWidget(self.mod1_A_value, 7, 1)
    self.tab4_grid_layout.addWidget(self.mod1_mic_value, 8, 1)
    self.tab4_grid_layout.addWidget(self.mod1_mac_value, 9, 1)
    self.tab4_grid_layout.addWidget(self.mod2_label, 1, 2)
    self.tab4_grid_layout.addWidget(self.mod2_ff_value, 2, 2)
    self.tab4_grid_layout.addWidget(self.mod2_T_value, 3, 2)
    self.tab4_grid_layout.addWidget(self.mod2_B_value, 4, 2)
    self.tab4_grid_layout.addWidget(self.mod2_V_value, 5, 2)
    self.tab4_grid_layout.addWidget(self.mod2_G_value, 6, 2)
    self.tab4_grid_layout.addWidget(self.mod2_A_value, 7, 2)
    self.tab4_grid_layout.addWidget(self.mod2_mic_value, 8, 2)
    self.tab4_grid_layout.addWidget(self.mod2_mac_value, 9, 2)
...
def widgets(self):
    ...
    self.pixel_values = QLabel("")
    self.pixel_values.setStyleSheet("background-color: white")
    self.x_spinbox = QSpinBox(self)
    self.x_spinbox.setPrefix("x: ")
    self.x_spinbox.valueChanged.connect(self.xy_spinbox)
    self.x_spinbox.singleStep()
    self.y_spinbox = QSpinBox(self)
    self.y_spinbox.setPrefix("y: ")
    self.y_spinbox.valueChanged.connect(self.xy_spinbox)
    self.y_spinbox.singleStep()
    #-------widgets for canvas-------#
