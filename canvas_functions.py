...
def show(sire, class_object):
    ...
    if sire.flag == False or sire.frame_changed_flag == 1:
        open_files(sire,class_object)
    update_canvas(sire,class_object)
    sire.sc1.fig1.canvas.draw()


def open_files(sire,class_object):
    ...
    if model1.ndim == 5:  # executed only if there are multiple frames of data
        #self.frame_scale.setEnable(True)
        ...
        if sire.flag == False:
            ...
            sire.frame_scale.setMaximum(class_object['class_object'].Attributes["t"] - 1)
    ...
    if sire.flag == False:
        ...
        sire.wl_scale.setMaximum(class_object["class_object"].Attributes["wl"] - 1)
        ...
        sire.wl_max_entry.setText(str(class_object["class_object"].Attributes["wl"] - 1))

        sire.optical_depth_scale.setMinimum(0)
        sire.optical_depth_scale.setMaximum(class_object["class_object"].Attributes["optical_depth"] - 1)
        ...
        sire.optical_depth_max_entry.setText(str(class_object["class_object"].Attributes["optical_depth"] - 1))
    ...
    if sire.binary_checkbutton.isChecked():
        ...
        binary_map = np.ones([class_object["class_object"].Attributes["y"], class_object["class_object"].Attributes["x"]])
        class_object["class_object"].update_binary(binary_map)
...
def update_canvas(sire,class_object):
    ...
    if sire.Stokes_checkbutton.isChecked():
        if sire.StkI_CT[3] == 0:
            StkI_map = sire.sc1.ax1.imshow(obs_prof[0, class_object["class_object"].current_wl_index, :, :], origin='lower',
    ...
    if sire.Stokes_Q_checkbutton.isChecked():
        if sire.StkQ_CT[3] == 0:
            StkQ_map = sire.sc1.ax2.imshow(obs_prof[1, class_object["class_object"].current_wl_index, :, :], origin='lower',
    ...
    if sire.Stokes_U_checkbutton.isChecked():
        if sire.StkU_CT[3] == 0:
            StkU_map = sire.sc1.ax3.imshow(obs_prof[2, class_object["class_object"].current_wl_index, :, :], origin='lower',
    ...
    if sire.Stokes_V_checkbutton.isChecked():
        if sire.StkV_CT[3] == 0:
            StkV_map = sire.sc1.ax4.imshow(obs_prof[3, class_object["class_object"].current_wl_index, :, :], origin='lower',
    ...
    if sire.T_checkbutton.isChecked():
        if sire.T_CT[3] == 0:
            T_map = sire.sc1.ax5.imshow(model1[1, class_object["class_object"].current_optical_depth_index, :, :],
...
def click(sire, class_object):
    ...
    sire.sc2.ax1.axvline(class_object["class_object"].current_wl_index, linestyle=':', color='gray', linewidth=sire.linewidth)
    ...
    sire.sc2.ax1.set_xlim(class_object["class_object"].wl_min, class_object["class_object"].wl_max)
    sire.sc2.ax2.plot(obs_prof[1, :, int(current_y), int(current_x)], linewidth=sire.linewidth)
    sire.sc2.ax2.axvline(class_object["class_object"].current_wl_index, linestyle=':', color='gray', linewidth=sire.linewidth)
    sire.sc2.ax2.plot(syn_prof[1, :, int(current_y), int(current_x)], linewidth=sire.linewidth)
    sire.sc2.ax2.set_xlim(class_object["class_object"].wl_min, class_object["class_object"].wl_max)
    sire.sc2.ax3.plot(obs_prof[2, :, int(current_y), int(current_x)], linewidth=sire.linewidth)
    sire.sc2.ax3.axvline(class_object["class_object"].current_wl_index, linestyle=':', color='gray', linewidth=sire.linewidth)
    sire.sc2.ax3.plot(syn_prof[2, :, int(current_y), int(current_x)], linewidth=sire.linewidth)
    sire.sc2.ax3.set_xlim(class_object["class_object"].wl_min, class_object["class_object"].wl_max)
    sire.sc2.ax4.plot(obs_prof[3, :, int(current_y), int(current_x)], linewidth=sire.linewidth)
    sire.sc2.ax4.axvline(class_object["class_object"].current_wl_index, linestyle=':', color='gray', linewidth=sire.linewidth)
    sire.sc2.ax4.plot(syn_prof[3, :, int(current_y), int(current_x)], linewidth=sire.linewidth)
    sire.sc2.ax4.set_xlim(class_object["class_object"].wl_min, class_object["class_object"].wl_max)
    ...
    sire.sc3.ax1.axvline(model1[0, class_object["class_object"].current_optical_depth_index, int(current_y), int(current_x)],
        linestyle=':', color='gray', linewidth=sire.linewidth)
    sire.sc3.ax1.set_xlim(model1[0, class_object["class_object"].optical_depth_min, int(current_y), int(current_x)], model1[0, class_object["class_object"].optical_depth_max, int(current_y), int(current_x)])

    sire.sc3.ax2.plot(model1[0, :, int(current_y), int(current_x)], model1[4, :, int(current_y), int(current_x)],
        linestyle='solid', color='red', linewidth=sire.linewidth)
    sire.sc3.ax2.axvline(model1[0, class_object["class_object"].current_optical_depth_index, int(current_y), int(current_x)],
        linestyle=':', color='gray', linewidth=sire.linewidth)
    sire.sc3.ax2.set_xlim(model1[0, class_object["class_object"].optical_depth_min, int(current_y), int(current_x)], model1[0, class_object["class_object"].optical_depth_max, int(current_y), int(current_x)])

    sire.sc3.ax3.plot(model1[0, :, int(current_y), int(current_x)], model1[5, :, int(current_y), int(current_x)] / (100 * 1000),
        linestyle='solid', color='red', linewidth=sire.linewidth)
    sire.sc3.ax3.axvline(model1[0, class_object["class_object"].current_optical_depth_index, int(current_y), int(current_x)],
        linestyle=':', color='gray', linewidth=sire.linewidth)
    sire.sc3.ax3.set_xlim(model1[0, class_object["class_object"].optical_depth_min, int(current_y), int(current_x)], model1[0, class_object["class_object"].optical_depth_max, int(current_y), int(current_x)])
    ...
    sire.sc3.ax4.axvline(model1[0, class_object["class_object"].current_optical_depth_index, int(current_y), int(current_x)],
        linestyle=':', color='gray', linewidth=sire.linewidth)
    ...
    sire.sc3.ax4.set_xlim(model1[0, class_object["class_object"].optical_depth_min, int(current_y), int(current_x)], model1[0, class_object["class_object"].optical_depth_max, int(current_y), int(current_x)])
...
def change_frame(sire):
    ...
    i = str(sire.match)
    sire.class_objects[i]['class_object'].current_frame_index = int(sire.frame_scale.value())
    sire.change_canvas()
    click(sire, sire.class_objects[i])
    update_pixel_info(sire, sire.class_objects[i])
    sire.frame_changed_flag=0


def change_wl(sire):
    i = str(sire.match)
    sire.class_objects[i]['class_object'].current_wl_index = int(sire.wl_scale.value())
    sire.change_canvas()
    click(sire, sire.class_objects[i])
    update_pixel_info(sire, sire.class_objects[i])
...
def change_optical_depth(sire):
    ...
    i = str(sire.match)
    sire.class_objects[i]['class_object'].current_optical_depth_index = int(optical_depth)
    sire.change_canvas()
    click(sire, sire.class_objects[i])
    update_pixel_info(sire, sire.class_objects[i])
...
def update_pixel_info(sire, class_object):
    ...
    sire.pixel_values.setText("X: %s Y: %s Z: %s [cm] OD: %s" %(str(int(class_object["class_object"].current_x)), str(int(class_object["class_object"].current_y)), str(Z), str(OD)))
